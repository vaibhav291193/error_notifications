...
document.getElementById("petName1").setAttribute('border-color', '#666666');
...
document.getElementById("petType1").setAttribute('border-color', '#666666');
...
document.getElementById("petName1").setAttribute('border-color', '#ca261a');
...
document.getElementById("petType1").setAttribute('border-color', '#ca261a');
...
document.getElementById("petName2").setAttribute('border-color', '#666666');
...
document.getElementById("petType2").setAttribute('border-color', '#666666');
...
document.getElementById("petName2").setAttribute('border-color', '#ca261a');
...
document.getElementById("petType2").setAttribute('border-color', '#ca261a');
